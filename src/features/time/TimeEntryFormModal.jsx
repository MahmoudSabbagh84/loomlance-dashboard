    ...
    try {
      if (isEdit) {
        await update.mutateAsync({
          id: entry.id,
          patch: { project_id: v.project_id, description: v.description, billable: v.billable, hourly_rate: hourlyRate, duration_minutes: durationMinutes },
        })
      } else {
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <div>
            ...
            <Input id="hours" type="number" min="0" {...register('hours')} />
          </div>
          <div>
